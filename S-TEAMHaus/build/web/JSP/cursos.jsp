<%-- 
    Document   : cursos
    Created on : 12 oct. 2024, 21:35:57
    Author     : diego
--%>
    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="cnt-cursosRobot-container">
                <div class="cnt-cursosRobot">
                    <aside class="cnt-cursosRobot-aside">
                        <div class="cnt-cursosRobot-aside-imagen">
                            <img src="../IMAGENES/OTTOBOTV.svg" alt="#" />
                        </div>
                        <h1>¡Hola! Soy OTTO </h1>
                        <p>Puedes armar a Otto mientras aprendes más cosas en nuestro curso que se dará en el mes de septiembre.</p>
                        <br> <br> <br><br>
                        <h1>¡CONOCE MÁS SOBRE OTTO!</h1>
                        <form action="robot1Curso.jsp">
                            <button class="box">¡HAZ CLICK!</button>
                        </form>
                    </aside>
                </div>

                <div class="cnt-cursosRobot">
                    <aside class="cnt-cursosRobot-aside2">
                        <div class="cnt-cursosRobot-aside-imagen">
                            <img src="../IMAGENES/ARES.png" alt="#" />
                        </div>
                        <br><br><br><br><br><br>
                        <h1>¡Hola! Soy ARES STEMKIT 2.2</h1>
                        <p>Puedes armar a Otto mientras aprendes más cosas en nuestro curso que se dará en el mes de septiembre.</p>
                        <br><br><br><br>
                        <h1>¡CONOCE MÁS SOBRE ARES!</h1>
                        <form action="robot1Curso.jsp">
                            <button class="box">¡HAZ CLICK!</button>
                        </form>
                        <br>
        ...
        <div class="cnt-PE0">
            <h1> PROGRESO EDUCATIVO </h1>
        </div>
    </div>
    <div class="container2">
        <div class="cnt-PE">
            <div class="cnt-PE1">
                <img src="../IMAGENES/STEMSITOCURSOS.svg" alt="STEMSITOCURSOS">
                <aside class="cnt-ProgresoEducativo-aside">
                    <h1>SIGUE SOÑANDO, SIGUE CONSTRUYENDO</h1>

                    <P> Aqui va el porcentaje del curso :)))</p>
                    <button class="box2" onclick="window.location.href = 'progresoEducativoCursos2.jsp'">CONTINUAR</button>
                </aside>
            </div>
            <div class="cnt-PE2">
                <img src="../IMAGENES/STEMSITOCURSOS2.svg" alt="STEMSITOCURSOS">
                <aside class="cnt-ProgresoEducativo-aside">
                    <h1>¡NO PARES, SIGUE AVANZANDO!</h1>
                    <P> Aqui va el porcentaje del curso :)))</p>
                    <button class="box2" onclick="window.location.href = 'progresoEducativoCursos.jsp'">CONTINUAR</button>
                </aside>
            </div>
        </div>
    </div>
