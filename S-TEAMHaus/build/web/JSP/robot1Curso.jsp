<%-- 
    Document   : robot1Curso
    Created on : 13 oct. 2024, 19:56:03
    Author     : diego
--%>
...
<html>
    <head>
        ...
        <link href="../CSS/robot1Curso.css" rel="stylesheet" type="text/css"/>
        <script src="../JS/codigoOTTOBOT.js" type="text/javascript"></script>
            ...
            <div class="temario">
                ...
                <div class="module">
                    <div class="module-header" onclick="toggleModule(this)">
                        ...
                        <span>PRIMER MODULO / INTRODUCCIÓN</span>
                        <span class="arrow">▼</span>
                    </div>
                    <div class="module-content">
                        <div class="class-item">
                            <span class="class-checkbox"></span>
                            <span>Clase 1: Bienvenida al curso</span>
                        </div>
                        <div class="class-item">
                            <span class="class-checkbox"></span>
                            <span>Clase 2: Objetivos y metodología</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="module">
                    <div class="module-header" onclick="toggleModule(this)">
                        <span class="checkbox"></span>
                        <span>SEGUNDO MÓDULO / FUNDAMENTOS</span>
                        <span class="arrow">▼</span>
                    </div>
                    <div class="module-content">
                        <div class="class-item">
                            <span class="class-checkbox"></span>
                            <span>Clase 1: Introducción a la robótica</span>
                        </div>
                        <div class="class-item">
                            <span class="class-checkbox"></span>
                            <span>Clase 2: Componentes básicos</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="module">
                    <div class="module-header" onclick="toggleModule(this)">
                        <span class="checkbox"></span>
                        <span>TERCER MÓDULO / CONSTRUCCIÓN DEL ROBOT</span>
                        <span class="arrow">▼</span>
                    </div>
                    <div class="module-content">
                        <div class="class-item">
                            <span class="class-checkbox"></span>
                            <span>Clase 1: Diseño del robot</span>
                        </div>
                        <div class="class-item">
                            <span class="class-checkbox"></span>
                            <span>Clase 2: Ensamblaje de componentes</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="convince">
                    <h2>¿TE CONVENCE?</h2>
                    <button class="btn-conoceme">¡CONOCEME!</button>
                    <img src="../IMAGENES/ARES.png" alt="Robot" class="robot-image">
                    <p class="robot-name">Ares-Bot</p>
                </div>
            </div>

            <div class="card">
                <center><h2>Curso de OTTOBOT</h2></center>
                <video class="smartbot-video" controls>
                    <source src="../modulo3/20240816 Clase 03.mp4" type="video/mp4">
                    Tu navegador no soporta el elemento de video.
                </video>

                <div class="buttons">
                    <a href="ingresarCodigoOTTOBOT.jsp"><button class="btn btn-purple">Ingresa código</button></a>
                    <a href="robot2Compra.jsp"><button class="btn btn-blue">Comprar a SMARTBOT</button></a>
                </div>
                ...
                <div class="includes">
                    ...
                    <ul>
                        ...
                        <li>6 horas de videos de curso</li>
                        <li>Curso Online en vivo</li>
