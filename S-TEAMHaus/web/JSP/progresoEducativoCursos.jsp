<%-- 
    Document   : progresoEducativoCursos
    Created on : 7 dic. 2024, 19:35:14
    Author     : Usuario
--%>
...
<html>
    <head>
        ...
        <title>Progreso Educativo</title>
        <link href="https://fonts.googleapis.com/css2?family=Montserrat:wght@400;700&display=swap" rel="stylesheet">
        <script src="https://cdn.jsdelivr.net/npm/chart.js"></script>
        <link href="../CSS/progresoEducativo.css" rel="stylesheet" type="text/css"/>
    ...
    <main>
        ...
        <div class="cnt-derecho">
            <div class="card2">
                <img src="../IMAGENES/STEMSITOESTRELLITAS.svg" alt="#"/>
                <div class="message1">¡YA FALTA POCO!</div>
            </div>
        </div>

        <div class="card3">
            <h2>¡TÚ PUEDES HACERLO!</h2>
            <img src="../IMAGENES/STEMSITOCORAZON.svg" alt="#"/>
        </div>
...
<div class="cnt-BotonRegresar">
             <button class="box" onclick="window.location.href = 'cursos.jsp'">REGRESAR</button>
             </div>
</main>
<script>
    ...
    new Chart(progressCtx, {
        ...
        options: {
            ...
            plugins: {
                title: {
                    display: true,
                    text: 'Progreso General de Cursos'
                }
            }
        }
    });

    // Gráfica de Tiempo Dedicado por Curso
    const timeSpentCtx = document.getElementById('timeSpentChart').getContext('2d');
    new Chart(timeSpentCtx, {
        type: 'bar',
        data: {
            labels: ['Introducción', 'Programación', 'Sensores', 'Proyectos'],
            datasets: [{
        ...
        options: {
            ...
            plugins: {
                title: {
                    display: true,
                    text: 'Tiempo Dedicado por Curso'
                }
            },
            scales: {
                y: {
