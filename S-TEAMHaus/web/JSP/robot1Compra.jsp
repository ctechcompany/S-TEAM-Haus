...
<html>
    <head>
        ...
        <link href="../CSS/robot1Compra.css" rel="stylesheet" type="text/css"/>
        ...
        <header>
            ...
            <%
                ...
                if (sesionUser != null && sesionUser.getAttribute("id_usuario") != null) {
                    ...
                    int idUsuario = (int) sesionUser.getAttribute("id_usuario");
        ...
        <div class="container">
            ...
            <div class="cnt-div1">
                ...
                <div class="cnt-div1-imagenDescripcion">
                    ...
                    <ul>
                        <li><p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod..</p></li>
                        <li><p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et.</p></li>
            ...
            <div class="productosRelacionados">
                <%
                    for(int i=0; i<10;i++){        
                %>
                <div class="cnt-productosRelacionados-div">
                    <img src="../IMAGENES/imagenPCuadrado.png" alt="alt"/>
                    
                    <h3>Smart Robot</h3>
                    
                    <h3 class="precioAzul">$799 mnx</h3>
                </div>
                <%
                    }
                %>
