<%-- 
    ...
    Created on : 5 dic. 2024, 12:20:22
    Author     : Usuario
--%>
...
<html>
    ...
    <body>
        ...
        <div class="container">
            <div class="cnt-cursosRobot-container">
                <div class="cnt-EditarPerfil1">
                    <img src="../IMAGENES/STEMSITOCARAM2.svg" alt="STEMSITOCARAM2">
                    <aside class="cnt-cursosRobot-aside">
                        <h1><center>ACTUAL</center></h1>
                        <p>CORREO ELECTRÓNICO: <%= correo%></p>
                        <br>
                        <p>USER NAME: <%= userNameUsuario%></p>
                        <br>
                        <p>NOMBRE: <%= nombreUsuario%></p>
                        <br>
                        <p>APELLIDO(S): <%= apellidoUsuario%></p>
                        <br>
                        <p>EDAD: <%= edad%></p>
                        <br>
                ...
                <div class="cnt-EditarPerfil1">
                    <img src="../IMAGENES/STEMSITOCARAM2.svg" alt="STEMSITOCARAM2">
                    <aside class="cnt-cursosRobot-aside">
                        <h1><center>NUEVO</center></h1>
                        <script src="https://cdn.jsdelivr.net/npm/sweetalert2@11"></script>
                        <form class = "cnt-formEditar" action="editaInfoPersonal.jsp" onsubmit="return validarFormulario()" novalidate>
                            ...
                            <input type="email" value="<%= correo%>" id="correo" name="correo" required=""><br>
                            <p id="mensajeCorreo" style="color:red; font-size:small;"></p>
                            <br>
                            <label for="userNameUsuario">USER NAME</label>
                            <input type="text" value="<%= userNameUsuario%>" id="userNameUsuario" name="userNameUsuario" minlength="5" maxlength="15" required=""><br>
                            <p id="mensajeuserNameUsuario" style="color:red; font-size:small;"></p>
                            <br>
                            <label for="nombreUsuario">NOMBRE</label>
                            <input type="text" value="<%= nombreUsuario%>" id="nombreUsuario" name="nombreUsuario" required=""><br>
                            <p id="mensajeNombre" style="color:red; font-size:small;"></p>
                            <br>
                            <label for="apellidoUsuario">APELLIDO(S)</label>
                            <input type="text" value="<%= apellidoUsuario%>" id="apellidoUsuario" name="apellidoUsuario" required=""><br>
                            <p id="mensajeApellidos" style="color:red; font-size:small;"></p>
                            <br>
                            <label for="edad">EDAD</label>
                            <input type="number" value="<%= edad%>" id="edad" name="edad" min="12" max="100" required=""><br>
                            <p id="mensajeEdad" style="color:red; font-size:small;"></p>
                            <br>
                            <label for="contraseña">CONTRASEÑA</label>
                            <input type="text" value="<%= contraseña%>" id="contraseña" name="contraseña" minlength="8" maxlength="16" required=""><br>
                            <p id="mensajeContraseña" style="color:red; font-size:small;"></p>
                            <br>
                            <label for="telefono">TELÉFONO</label>
                            <input type="tel" value="<%= telefono%>" id="telefono" name="telefono" required=""><br>
                            <p id="mensajeTelefono" style="color:red; font-size:small;"></p>
                            <br> <br>
                            <button type="submit" class="buttonAzul">CONFIRMAR</button>
                        </form>
                    </aside>
                </div>
            </div>
        </div>
        <div class="cnt-BotonRegresar">
            <button type="button" class="buttonAzul2" onclick="window.location.href = 'miPerfil.jsp'">CANCELAR</button>
        </div>
        <footer>
