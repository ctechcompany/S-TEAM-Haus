<%-- 
    ...
    Created on : 13 oct. 2024, 11:44:50
    Author     : diego
--%>
...
<html>
    <head>
        ...
        <link href="../CSS/robot2Compra.css" rel="stylesheet" type="text/css"/>
    ...
    <body>
        ...
        <header>
            ...
            bd.cierraConexion();
                ...
                int precioTTE = 0;
                bd.conectar();
                String strQry = "select precio_robot, descripcion_robot from Robot where id_robot = '" + idRobot + "';";
                ResultSet rs1 = null;
                rs1 = bd.consulta(strQry);
                while (rs1.next()) {
                    precio = rs1.getString(1);
                    descripcion = rs1.getString(2);
                    switch (idRobot) {
                        case "1":
                            nombreR = "OTTO bot";
                            break;
        ...
        <script src="../JS/mostrarAlert.js" type="text/javascript"></script>
        <%
            String message = (String) request.getAttribute("message");
            if (message != null) {%>
        <script> mostrarMensaje("<%= message%>");</script>
        <%}%>
        <div class="container">

            <div class="cnt-div1">

                <div class="cnt-div1-overflow">
                ...
                <div class="cnt-div1-imagenDescripcion">
                ...
                <div class="cnt-div1-añadirAlCarrito">

                    <h1><%= nombreR%></h1>

                    <h2><b><%= precio%></b> mnx</h2>

                    <h3>Robot educativo el cual incluye un curso para armarlo</h3>
                    <script src="../JS/compras.js" type="text/javascript"></script>
                    <form action="enviarCarrito.jsp" onsubmit="return validarCantidad()" novalidate>
                        <input type="hidden" name="idRobot" value="2">
                        <h4>Cantidad</h4>
                        <input
                            required=""
                            ...
                            name="cantidad"
                            /> 
                        <p id="mensajeCantidad" style="color:red; font-size:small;"></p>
                        <button type="submit" class="buttonAzul">
                            Agregar al Carrito
                        </button>
                    </form>
                </div>
